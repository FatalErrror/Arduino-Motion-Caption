...
void MadgwickAHRS::MadgwickAHRSupdateIMU(float tdelta, float gx, float gy, float gz, float ax, float ay, float az) {
	float beta = 0.2f;
...
void MadgwickAHRS::quat2Euler(float q[4], float e[3]) {
	double sqx = q[1] * q[1];
	double sqy = q[2] * q[2];
	double sqz = q[3] * q[3];
